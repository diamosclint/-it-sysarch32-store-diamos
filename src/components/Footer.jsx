    ...
    return (
        <>
            <div className="grid justify-center">
                <h1 className="text-2xl font-semibold text-center mb-2">Sign Up for Updates</h1>
                <p className="font-medium text-dark-gray mb-6">Sign up and we’ll keep you up to date with the latest arrivals</p>
            </div>
            <div className="join flex justify-center mb-40">
                <input class="input input-bordered border-dark-gray join-item px-10" placeholder="Email" />
                <button class="btn join-item border-solid border-dark-gray">Subscribe</button>
            </div>
